from fitness_manager_agent.agent import root_agent as fitness_manager_agent # Updated
...
APP_NAME = "fitness_manager_app" # Updated
...
class AppContexts(SimpleNamespace):
    ...
    agent_runner: Runner = None # Renaming for clarity
...
async def lifespan(app: FastAPI):
    ...
    app_contexts.agent_runner = Runner(
        agent=fitness_manager_agent,  # Updated Agent
...
# Create FastAPI app
app = FastAPI(title="Personal Fitness & Nutrition Coach API", lifespan=lifespan) # Updated Title
...
async def chat(
    ...
    try:
        ...
        events_iterator: AsyncIterator[Event] = (
            app_context.agent_runner.run_async(
